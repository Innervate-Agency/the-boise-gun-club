  ...
  return (
    <section ref={heroRef} className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-20 bg-gradient-to-br from-color-lahoma-orange/10 via-transparent via-color-leonard-yellow/5 to-brand-blue/8" />
      ...
      <div className="absolute inset-0">
        {[...Array(8)].map((_, i) => {
          const colors = ['bg-color-leonard-yellow', 'bg-color-lahoma-orange', 'bg-accent-primary', 'bg-brand-red-action', 'bg-brand-blue', 'bg-brand-green', 'bg-brand-blue-dark'];
      ...
      <div className="relative z-20 min-h-screen flex items-center justify-center px-6">
        ...
        >
          ...
          >
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button 
                asChild
                size="lg" 
                className="relative overflow-hidden bg-gradient-to-r from-color-lahoma-orange via-accent-primary to-brand-red-action hover:from-brand-red-action hover:to-color-lahoma-orange text-white px-12 py-6 text-xl font-bold rounded-2xl transition-all duration-500 border-0 shadow-[0_0_40px_rgba(242,135,5,0.4),0_20px_40px_rgba(0,0,0,0.2)]"
              >
          ...
          >
            {[
              { icon: Target, title: "World-Class Ranges", desc: "30 championship-grade fields", color: "color-lahoma-orange", fractal: 11 },
              { icon: Star, title: "Family Community", desc: "Welcome all skill levels", color: "color-leonard-yellow", fractal: 19 },
              { icon: Trophy, title: "125+ Years Excellence", desc: "Proven tradition", color: "brand-blue", fractal: 27 }
            ].map((feature, i) => (
              <motion.div
                key={i}
                ...
                <Card className="relative overflow-hidden backdrop-blur-xl bg-transparent border border-white/8 group cursor-pointer h-full">
                  ...
                  <CardContent className="p-10 text-center relative z-10">
                    <div className={`w-20 h-20 mx-auto mb-6 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-500
                      ${feature.color === 'color-lahoma-orange' ? 'bg-gradient-to-br from-color-lahoma-orange to-color-lahoma-orange/50 shadow-orange-500/25' : ''}
                      ${feature.color === 'color-leonard-yellow' ? 'bg-gradient-to-br from-color-leonard-yellow to-color-leonard-yellow/50 shadow-yellow-500/25' : ''}
                      ${feature.color === 'brand-blue' ? 'bg-gradient-to-br from-brand-blue to-brand-blue/50 shadow-blue-500/25' : ''}`}
                    >
