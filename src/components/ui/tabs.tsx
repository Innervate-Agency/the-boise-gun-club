  ...
  "inline-flex items-center justify-center p-1 transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        premium: "bg-gradient-to-r from-[var(--color-leonard-yellow)]/10 to-[var(--color-lahoma-orange)]/10 backdrop-blur-sm border border-[var(--color-leonard-yellow)]/20 rounded-xl h-10 shadow-lg",
        glass: "bg-[var(--card)]/5 backdrop-blur-md border border-white/10 rounded-xl h-10 shadow-xl",
        tournament: "bg-gradient-to-r from-slate-900/90 to-slate-800/90 backdrop-blur-sm border border-[var(--color-leonard-yellow)]/30 rounded-xl h-12 shadow-2xl",
  ...
  "inline-flex items-center justify-center whitespace-nowrap font-medium transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        premium: "data-[state=active]:bg-gradient-to-r data-[state=active]:from-[var(--color-leonard-yellow)] data-[state=active]:to-[var(--color-lahoma-orange)] data-[state=active]:text-[var(--text-primary)] data-[state=active]:shadow-lg hover:bg-[var(--card)]/10 flex-1 gap-2 rounded-lg px-4 py-2 text-sm font-semibold transition-all duration-300 data-[state=active]:transform data-[state=active]:scale-105 [&_svg:not([class*='size-'])]:size-4",
        glass: "data-[state=active]:bg-[var(--card)]/20 data-[state=active]:backdrop-blur-sm data-[state=active]:border-white/30 data-[state=active]:shadow-lg hover:bg-[var(--card)]/10 flex-1 gap-2 rounded-lg border border-transparent px-4 py-2 text-sm font-medium transition-all duration-300 [&_svg:not([class*='size-'])]:size-4",
        tournament: "data-[state=active]:bg-gradient-to-r data-[state=active]:from-[var(--color-leonard-yellow)] data-[state=active]:to-[var(--color-lahoma-orange)] data-[state=active]:text-[var(--text-primary)] data-[state=active]:shadow-xl hover:bg-[var(--card)]/5 flex-1 gap-2 rounded-lg px-6 py-3 text-sm font-bold transition-all duration-300 data-[state=active]:transform data-[state=active]:scale-105 [&_svg:not([class*='size-'])]:size-5",
        minimal: "data-[state=active]:text-[var(--color-leonard-yellow)] data-[state=active]:border-b-2 data-[state=active]:border-[var(--color-leonard-yellow)] hover:text-[var(--color-lahoma-orange)] px-4 py-2 text-sm font-medium transition-all duration-300 rounded-none border-b-2 border-transparent [&_svg:not([class*='size-'])]:size-4",
      },
      size: {
