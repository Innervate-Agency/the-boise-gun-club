  ...
  "z-50 w-fit origin-(--radix-tooltip-content-transform-origin) rounded-xl px-3 py-2 text-xs text-balance font-medium shadow-lg border backdrop-blur-sm relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        success: "bg-brand-green text-[var(--card)] border-brand-green/30",
        warning: "bg-color-leonard-yellow text-[var(--card)] border-color-leonard-yellow/30",
        error: "bg-red-500 text-[var(--card)] border-[var(--brand-red-action)]/30",
        info: "bg-brand-blue text-[var(--card)] border-brand-blue/30",
        premium: "bg-gradient-to-r from-color-leonard-yellow to-color-lahoma-orange text-[var(--card)] border-color-leonard-yellow/50 shadow-xl",
        glass: "bg-[var(--card)]/10 backdrop-blur-xl text-[var(--card)] border-white/20",
        dark: "bg-gray-900 text-[var(--card)] border-gray-700",
      },
      size: {
  ...
  "z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px]",
  {
    variants: {
      variant: {
        ...
        warning: "bg-color-leonard-yellow fill-color-leonard-yellow border-color-leonard-yellow/30",
        error: "bg-red-500 fill-red-500 border-[var(--brand-red-action)]/30",
        info: "bg-brand-blue fill-brand-blue border-brand-blue/30",
        premium: "bg-color-leonard-yellow fill-color-leonard-yellow border-color-leonard-yellow/50",
        glass: "bg-[var(--card)]/10 fill-white/10 border-white/20 backdrop-blur-xl",
