  ...
  "inline-flex items-center justify-center rounded-full border font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:pointer-events-none transition-all duration-200 ease-out relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        success: "border-brand-green/30 bg-brand-green/10 text-brand-green hover:bg-brand-green/20 hover:border-brand-green/50",
        warning: "border-leonard-yellow/50 bg-leonard-yellow/10 text-leonard-yellow hover:bg-leonard-yellow/20 hover:border-leonard-yellow/70",
        error: "border-red-500/30 bg-red-500/10 text-red-500 hover:bg-red-500/20 hover:border-red-500/50",
        info: "border-brand-blue/30 bg-brand-blue/10 text-brand-blue hover:bg-brand-blue/20 hover:border-brand-blue/50",
        premium: "border-leonard-yellow/50 bg-gradient-to-r from-leonard-yellow/20 to-lahoma-orange/20 text-leonard-yellow hover:from-leonard-yellow/30 hover:to-lahoma-orange/30 hover:border-leonard-yellow/70 shadow-sm",
