...
const NewThemeToggle = () => {
  ...
  return (
    <motion.button
      ...
      className="fixed bottom-28 left-4 z-50 p-3 bg-[var(--bg-secondary)] text-[var(--text-primary)] rounded-full shadow-lg hover:bg-[var(--bg-tertiary)] transition-colors duration-200"
