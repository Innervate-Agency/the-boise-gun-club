...
const NewThemeToggle = () => {
  ...
  return (
    <motion.button
      ...
      className="fixed bottom-6 left-24 z-50 p-4 bg-slate-800 text-white rounded-full shadow-xl hover:bg-slate-700 transition-all duration-200 border-2 border-red-600/20 hover:border-red-600/40"
