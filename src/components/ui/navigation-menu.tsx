...
const navigationMenuVariants = cva(
  "group/navigation-menu relative flex max-w-max flex-1 items-center justify-center transition-all duration-300",
  {
    variants: {
      variant: {
        default: "",
        premium: "bg-gradient-to-r from-[var(--color-leonard-yellow)]/5 to-[var(--color-lahoma-orange)]/5 backdrop-blur-sm rounded-xl p-2 shadow-lg",
  ...
  "group inline-flex w-max items-center justify-center font-medium disabled:pointer-events-none disabled:opacity-50 outline-none transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        premium: "h-10 rounded-lg px-5 py-2.5 text-sm font-semibold hover:bg-gradient-to-r hover:from-[var(--color-leonard-yellow)]/20 hover:to-[var(--color-lahoma-orange)]/20 data-[state=open]:bg-gradient-to-r data-[state=open]:from-[var(--color-leonard-yellow)] data-[state=open]:to-[var(--color-lahoma-orange)] data-[state=open]:text-[var(--text-primary)] transform hover:scale-105 active:scale-95",
        ...
        tournament: "h-12 rounded-lg px-6 py-3 text-sm font-bold hover:bg-gradient-to-r hover:from-[var(--color-leonard-yellow)]/30 hover:to-[var(--color-lahoma-orange)]/30 data-[state=open]:bg-gradient-to-r data-[state=open]:from-[var(--color-leonard-yellow)] data-[state=open]:to-[var(--color-lahoma-orange)] data-[state=open]:text-[var(--text-primary)] transform hover:scale-105 active:scale-95",
        minimal: "h-9 rounded-none px-4 py-2 text-sm hover:text-[var(--color-leonard-yellow)] data-[state=open]:text-[var(--color-leonard-yellow)] data-[state=open]:border-b-2 data-[state=open]:border-[var(--color-leonard-yellow)]",
      },
    },
    defaultVariants: {
      variant: "default",
  ...
  "origin-top-center data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden border shadow md:w-[var(--radix-navigation-menu-viewport-width)]",
  {
    variants: {
      variant: {
        ...
        premium: "bg-gradient-to-b from-white/95 to-white/90 dark:from-slate-900/95 dark:to-slate-800/90 backdrop-blur-md border-[var(--color-leonard-yellow)]/20 rounded-xl shadow-2xl",
        glass: "bg-[var(--card)]/10 backdrop-blur-md border-white/20 rounded-xl shadow-2xl text-[var(--card)]",
        tournament: "bg-gradient-to-b from-slate-900/95 to-slate-800/95 backdrop-blur-md border-[var(--color-leonard-yellow)]/30 rounded-xl shadow-2xl text-[var(--card)]",
  ...
  "flex flex-col gap-1 text-sm transition-all outline-none [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        premium: "data-[active=true]:bg-gradient-to-r data-[active=true]:from-[var(--color-leonard-yellow)]/20 data-[active=true]:to-[var(--color-lahoma-orange)]/20 hover:bg-gradient-to-r hover:from-[var(--color-leonard-yellow)]/10 hover:to-[var(--color-lahoma-orange)]/10 focus:bg-gradient-to-r focus:from-[var(--color-leonard-yellow)]/20 focus:to-[var(--color-lahoma-orange)]/20 rounded-lg p-3 font-medium transform hover:scale-105 active:scale-95",
        ...
        tournament: "data-[active=true]:bg-gradient-to-r data-[active=true]:from-[var(--color-leonard-yellow)]/30 data-[active=true]:to-[var(--color-lahoma-orange)]/30 hover:bg-gradient-to-r hover:from-[var(--color-leonard-yellow)]/20 hover:to-[var(--color-lahoma-orange)]/20 focus:bg-gradient-to-r focus:from-[var(--color-leonard-yellow)]/30 focus:to-[var(--color-lahoma-orange)]/30 rounded-lg p-3 font-semibold transform hover:scale-105 active:scale-95",
        minimal: "data-[active=true]:text-[var(--color-leonard-yellow)] hover:text-[var(--color-leonard-yellow)] focus:text-[var(--color-leonard-yellow)] rounded-none p-2",
      },
    },
    defaultVariants: {
      variant: "default",
