...
export const NavigationVariants: Story = {
  render: () => (
    <div className="space-y-8">
      <div>
        <h3 className="text-lg font-heading font-bold text-craters-of-the-moon mb-4">Default Navigation</h3>
        <SiteNavigation variant="default" layout="horizontal" showLogo={true} />
      </div>
      
      <div>
        <h3 className="text-lg font-heading font-bold text-craters-of-the-moon mb-4">Premium Navigation</h3>
        <SiteNavigation variant="premium" layout="horizontal" showLogo={true} />
      </div>
      
      <div>
        <h3 className="text-lg font-heading font-bold text-craters-of-the-moon mb-4">Elite Navigation</h3>
        <SiteNavigation variant="elite" layout="horizontal" showLogo={true} />
      </div>
      
      <div>
        <h3 className="text-lg font-heading font-bold text-craters-of-the-moon mb-4">Gun Club Navigation</h3>
...
export const ResponsiveDesign: Story = {
  render: () => (
    <div className="space-y-8">
      <div>
        <h3 className="text-lg font-heading font-bold text-craters-of-the-moon mb-4">Desktop View</h3>
      ...
      <div>
        <h3 className="text-lg font-heading font-bold text-craters-of-the-moon mb-4">Mobile View</h3>
      ...
      <SiteNavigation 
        ...
        customContent={
          <div className="flex items-center gap-4">
            <button className="px-4 py-2 bg-leonard-yellow text-craters-of-the-moon font-medium rounded-md hover:bg-lahoma-orange transition-colors">
              Member Login
            </button>
            <button className="px-4 py-2 bg-transparent text-craters-of-the-moon font-medium border border-desert-cliff-brown rounded-md hover:bg-desert-cliff-brown/10 transition-colors">
              Join Now
            </button>
          </div>
        }
  ...
  render: () => (
    <div className="dark">
      <div className="bg-kent-slate-gray min-h-screen">
        <SiteNavigation variant="premium" layout="horizontal" showLogo={true} />
        <div className="p-8">
          <h2 className="text-xl font-heading font-bold text-chester-white mb-4">Dark Mode Navigation</h2>
  ...
  render: () => (
    <div className="space-y-6">
      ...
      <div className="p-6 bg-cloudy-day-white rounded-lg">
        <h3 className="text-lg font-heading font-bold text-craters-of-the-moon mb-4">Accessibility Features</h3>
