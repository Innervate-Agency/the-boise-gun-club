...
export const CompetitionResults: Story = {
  args: {
    ...
    icon: Trophy,
    gradient: 'bg-gradient-to-r from-var(--leonard-yellow) to-var(--lahoma-orange)',
...
export const EventRegistration: Story = {
  args: {
    ...
    icon: Calendar,
    gradient: 'bg-gradient-to-r from-var(--brand-blue) to-var(--lahoma-orange)',
...
export const MembershipApplication: Story = {
  args: {
    ...
    icon: Users,
    gradient: 'bg-gradient-to-r from-var(--brand-green) to-var(--lahoma-orange)',
...
export const ClubRules: Story = {
  args: {
    ...
    icon: BookOpen,
    gradient: 'bg-gradient-to-r from-var(--brand-red) to-var(--lahoma-orange)',
