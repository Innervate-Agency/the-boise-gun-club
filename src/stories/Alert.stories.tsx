...
export const GunClubExamples: Story = {
  render: () => (
    <div className="space-y-6">
      <h2 className="text-2xl font-heading font-bold mb-4">Gun Club Context</h2>
...
export const FusionShowcase: Story = {
  render: () => (
    <div className="space-y-8">
      <h2 className="text-2xl font-heading font-bold mb-4">Triple Fusion Design</h2>
      
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Stripe Precision */}
        <div className="space-y-4">
          <h3 className="font-heading font-semibold text-lg">Stripe Precision</h3>
          <Alert variant="default">
            <Info />
        ...
        {/* ClickUp Vibrancy */}
        <div className="space-y-4">
          <h3 className="font-heading font-semibold text-lg">ClickUp Vibrancy</h3>
          <Alert variant="warning">
            <AlertTriangle />
        ...
        {/* Windows 11 Mica */}
        <div className="space-y-4">
          <h3 className="font-heading font-semibold text-lg">Windows 11 Mica</h3>
          <Alert variant="premium">
            <Zap />
      ...
      <div className="bg-card/50 rounded-xl p-6 border border-border/20">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="font-heading font-semibold">Result: Professional Authority</h3>
        </div>
...
export const Playground: Story = {
  ...
  render: (args) => (
    <div className="space-y-4">
      <h3 className="font-heading font-semibold">Interactive Alert</h3>
      <Alert {...args}>
        <Zap />
