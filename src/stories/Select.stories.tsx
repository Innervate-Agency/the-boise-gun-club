  ...
  render: () => (
    <div className="space-y-6 max-w-lg">
      <div className="space-y-3">
        <h3 className="font-heading font-semibold text-lg text-card-foreground">Classification Select</h3>
        <ClassificationSelect placeholder="Select your classification..." />
      </div>

      <div className="space-y-3">
        <h3 className="font-heading font-semibold text-lg text-card-foreground">Range Select</h3>
        <RangeSelect placeholder="Choose a range..." />
      </div>

      <div className="space-y-3">
        <h3 className="font-heading font-semibold text-lg text-card-foreground">Tournament Registration</h3>
        <Select variant="premium">
