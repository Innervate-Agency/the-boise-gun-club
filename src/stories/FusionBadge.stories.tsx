...
export const AllVariants: Story = {
  render: () => (
    <div className="space-y-8">
      <h2 className="text-2xl font-heading font-bold mb-4">Badge Variants</h2>
...
export const Classifications: Story = {
  render: () => (
    <div className="space-y-8">
      <h2 className="text-2xl font-heading font-bold mb-4">Shooting Classifications</h2>
...
export const MembershipStatus: Story = {
  render: () => (
    <div className="space-y-8">
      <h2 className="text-2xl font-heading font-bold mb-4">Membership Status</h2>
      ...
      <div className="bg-card/50 rounded-xl p-6 border border-border/20">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="font-heading font-semibold">Member Directory</h3>
        </div>
        <div className="space-y-3">
          <div className="flex items-center justify-between">
...
export const ScoreBadges: Story = {
  render: () => (
    <div className="space-y-8">
      <h2 className="text-2xl font-heading font-bold mb-4">Score Indicators</h2>
      ...
      <div className="bg-card/50 rounded-xl p-6 border border-border/20">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="font-heading font-semibold">Recent Scores</h3>
        </div>
        <div className="space-y-3">
          <div className="flex items-center justify-between">
...
export const EventBadges: Story = {
  render: () => (
    <div className="space-y-8">
      <h2 className="text-2xl font-heading font-bold mb-4">Event & Tournament Badges</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-card/50 rounded-xl p-6 border border-border/20">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="font-heading font-semibold">Event Status</h3>
          </div>
          <div className="space-y-3">
            <div className="flex items-center justify-between">
...
export const Playground: Story = {
  ...
  render: (args) => (
    <div className="space-y-4">
      <h3 className="font-heading font-semibold">Interactive Badge</h3>
      <Badge {...args} />
    </div>
  ),
};
