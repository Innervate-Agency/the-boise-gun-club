  ...
  args: {
    children: (
      <div className="text-center">
        <Target className="mx-auto mb-4 h-12 w-12 text-var(--lahoma-orange)" />
        ...
        <Button className="bg-var(--lahoma-orange) hover:bg-var(--leonard-yellow)">
          Learn More
        </Button>
      </div>
    )
...
export const MembershipPromotion: Story = {
  args: {
    children: (
      <div className="text-center">
        <Badge className="mb-4 bg-var(--leonard-yellow) text-var(--rich-black)">
          Limited Time Offer
        </Badge>
        <Trophy className="mx-auto mb-4 h-12 w-12 text-var(--lahoma-orange)" />
        <h3 className="text-2xl font-bold text-var(--foreground) mb-2">
          50% Off First Year
        </h3>
        <p className="text-var(--muted-foreground) mb-4">
...
export const EventAnnouncement: Story = {
  args: {
    children: (
      <div className="text-center">
        <Calendar className="mx-auto mb-4 h-12 w-12 text-var(--lahoma-orange)" />
        <h3 className="text-2xl font-bold text-var(--foreground) mb-2">
        ...
        <div className="bg-var(--muted)/50 rounded-lg p-3 mb-4">
...
export const TrainingProgram: Story = {
  args: {
    children: (
      <div className="text-center">
        <Users className="mx-auto mb-4 h-12 w-12 text-var(--lahoma-orange)" />
        <h3 className="text-2xl font-bold text-var(--foreground) mb-2">
...
export const AchievementShowcase: Story = {
  args: {
    children: (
      <div className="text-center">
        <Star className="mx-auto mb-4 h-12 w-12 text-var(--leonard-yellow)" />
        <h3 className="text-2xl font-bold text-var(--foreground) mb-2">
        ...
        <div className="space-y-2 mb-4">
          <div className="flex justify-between items-center bg-var(--muted)/50 rounded p-2">
            <span className="text-sm font-medium">John Smith</span>
            <Badge className="bg-var(--leonard-yellow) text-var(--rich-black)">1st Place</Badge>
          </div>
          <div className="flex justify-between items-center bg-var(--muted)/50 rounded p-2">
      ...
      <div className="text-center">
        ...
        <div className="space-y-3">
          <input
            ...
            className="w-full px-3 py-2 border rounded-md bg-var(--background) text-var(--foreground) border-var(--border)"
          />
    ...
    children: (
      <div>
        <div className="text-center mb-6">
          <Target className="mx-auto mb-4 h-16 w-16 text-var(--lahoma-orange)" />
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="text-center">
            <div className="text-2xl font-bold text-var(--lahoma-orange)">12</div>
            <div className="text-sm text-var(--muted-foreground)">Shooting Lanes</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-var(--lahoma-orange)">3</div>
            <div className="text-sm text-var(--muted-foreground)">Trap Fields</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-var(--lahoma-orange)">2</div>
            <div className="text-sm text-var(--muted-foreground)">Skeet Fields</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-var(--lahoma-orange)">1</div>
            <div className="text-sm text-var(--muted-foreground)">Sporting Clays</div>
          </div>
        </div>
