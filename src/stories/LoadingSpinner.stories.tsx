  ...
  render: () => (
    <div className="space-y-8">
      <div className="flex items-center gap-4 p-4 bg-cloudy-day-white rounded-lg">
        ...
        <span className="text-craters-of-the-moon">Processing membership application...</span>
      </div>
      <div className="flex items-center gap-4 p-4 bg-cloudy-day-white rounded-lg">
        <LoadingSpinner size="sm" text="" />
        <span className="text-craters-of-the-moon">Loading range schedule...</span>
      </div>
      <div className="flex items-center gap-4 p-4 bg-cloudy-day-white rounded-lg">
        <LoadingSpinner size="sm" text="" />
        <span className="text-craters-of-the-moon">Submitting competition scores...</span>
      </div>
    </div>
  ),
}; 