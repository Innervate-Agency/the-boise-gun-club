  ...
  render: () => (
    <div className="space-y-6 max-w-lg">
      <div className="space-y-4">
        <h3 className="text-lg font-heading font-semibold text-card-foreground">Member Registration</h3>
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-heading font-semibold text-card-foreground">Payment Information</h3>
