...
- `className="text-lahoma-orange"` - Use Tailwind color names (defined in config)
...
### Color Usage Rules
- ✅ Always use Tailwind color names: `bg-lahoma-orange` (defined in tailwind.config.js)
- ❌ NEVER use hardcoded Tailwind colors: `bg-orange-500`
- ❌ NEVER use CSS variable syntax: `bg-[var(--lahoma-orange)]`
- ✅ Primary accent: `lahoma-orange` (#F28705)
- ✅ Secondary accent: `leonard-yellow` (#F2CB05)
- ✅ Success: `brand-green` (#6f7822)
