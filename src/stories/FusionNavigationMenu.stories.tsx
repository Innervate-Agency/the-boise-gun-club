...
const meta: Meta<typeof NavigationMenu> = {
  title: 'Fusion/Navigation/NavigationMenu',
  component: NavigationMenu,
  parameters: {
    layout: 'padded',
    docs: {
      description: {
        component: 'Fusion navigation menu component with ClickUp + Stripe design system. Features premium variants, glassmorphism effects, and gun club presets.',
      },
    },
  },
  tags: ['autodocs'],
          ...
          <NavigationMenuContent>
            <div className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              <div className="row-span-3">
                <NavigationMenuLink
                  variant="premium"
                  className="flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-[#F2CB05]/20 to-[#F28705]/20 p-6 no-underline outline-none focus:shadow-md"
                  href="/"
                >
                  <Trophy className="h-6 w-6 text-[#F2CB05]" />
                  <div className="mb-2 mt-4 text-lg font-medium text-[#F2CB05]">
                    Elite Championships
                  </div>
                  <p className="text-sm leading-tight text-muted-foreground">
          ...
          <NavigationMenuContent>
            <div className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px]">
              <NavigationMenuLink variant="premium" className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none">
                <Calendar className="h-4 w-4 mb-2 text-[#F2CB05]" />
              ...
              <NavigationMenuLink variant="premium" className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none">
                <Users className="h-4 w-4 mb-2 text-[#F2CB05]" />
              ...
              <NavigationMenuLink variant="premium" className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none">
                <Target className="h-4 w-4 mb-2 text-[#F2CB05]" />
              ...
              <NavigationMenuLink variant="premium" className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none">
                <Settings className="h-4 w-4 mb-2 text-[#F2CB05]" />
            ...
            <NavigationMenuContent>
              <div className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                <div className="row-span-3">
                  <NavigationMenuLink
                    variant="tournament"
                    className="flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-slate-800/90 to-slate-700/90 p-6 no-underline outline-none focus:shadow-md border border-[#F2CB05]/30"
                    href="/"
                  >
                    <Trophy className="h-6 w-6 text-[#F2CB05]" />
                    <div className="mb-2 mt-4 text-lg font-medium text-[#F2CB05]">
          ...
          <NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <div className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px]">
                ...
                <NavigationMenuLink variant="tournament" className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none text-white">
                  <FileText className="h-4 w-4 mb-2 text-[#F2CB05]" />
                ...
                <NavigationMenuLink variant="tournament" className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none text-white">
                  <Trophy className="h-4 w-4 mb-2 text-[#F2CB05]" />
...
export const SiteNavigationPreset: Story = {
  render: () => (
    <div className="space-y-8">
      ...
      <div>
        <h3 className="font-semibold mb-4">Tournament Navigation</h3>
        <SiteNavigation section="tournament">
          <NavigationMenuList variant="premium">
            <TournamentNavigationItem>
              <NavigationMenuTrigger variant="premium">
                Elite Series
              ...
              <NavigationMenuContent>
                <div className="grid gap-3 p-4 md:w-[400px]">
                  <NavigationMenuLink variant="premium" href="/tournaments/elite/leaderboard">
                    <div className="text-sm font-medium">Live Leaderboard</div>
                  </NavigationMenuLink>
                  <NavigationMenuLink variant="premium" href="/tournaments/elite/schedule">
                    <div className="text-sm font-medium">Match Schedule</div>
                  </NavigationMenuLink>
                </div>
              </NavigationMenuContent>
            </TournamentNavigationItem>
            <ScheduleNavigationItem>
              <NavigationMenuLink variant="premium" href="/tournaments/schedule">
                Event Calendar
              </NavigationMenuLink>
            </ScheduleNavigationItem>
          </NavigationMenuList>
      ...
      <div className="bg-gradient-to-br from-slate-900 to-slate-800 p-6 rounded-xl">
        <h3 className="font-semibold mb-4 text-white">Member Portal Navigation</h3>
        <SiteNavigation section="member">
          <NavigationMenuList variant="glass">
            <MembershipNavigationItem>
              <NavigationMenuTrigger variant="glass">
                Member Portal
            ...
            <SafetyNavigationItem>
              <NavigationMenuLink variant="glass" href="/member/safety">
                Safety Certification
              </NavigationMenuLink>
            </SafetyNavigationItem>
            <RangeNavigationItem>
              <NavigationMenuLink variant="glass" href="/member/bookings">
                Range Bookings
              </NavigationMenuLink>
            </RangeNavigationItem>
          </NavigationMenuList>
...
export const AdminNavigationPreset: Story = {
  render: () => (
    <div className="bg-gradient-to-br from-slate-900 to-slate-700 p-8 rounded-xl">
      <AdminNavigation>
        <NavigationMenuList variant="tournament">
          <NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <div className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-2">
                <NavigationMenuLink variant="tournament" href="/admin/users">
                  <div className="text-sm font-medium text-white">User Management</div>
                  <p className="text-xs text-slate-300">Manage member accounts</p>
                </NavigationMenuLink>
                <NavigationMenuLink variant="tournament" href="/admin/settings">
                  <div className="text-sm font-medium text-white">System Settings</div>
                  <p className="text-xs text-slate-300">Configure club systems</p>
                </NavigationMenuLink>
                <NavigationMenuLink variant="tournament" href="/admin/reports">
                  <div className="text-sm font-medium text-white">Reports</div>
                  <p className="text-xs text-slate-300">Generate system reports</p>
                </NavigationMenuLink>
                <NavigationMenuLink variant="tournament" href="/admin/backup">
                  <div className="text-sm font-medium text-white">Backup & Recovery</div>
                  <p className="text-xs text-slate-300">Data management</p>
                </NavigationMenuLink>
              </div>
            </NavigationMenuContent>
          </NavigationMenuItem>
          <TournamentNavigationItem>
            ...
            <NavigationMenuContent>
              <div className="grid gap-3 p-4 md:w-[400px]">
                <NavigationMenuLink variant="tournament" href="/admin/tournaments/create">
                  <div className="text-sm font-medium text-white">Create Tournament</div>
                </NavigationMenuLink>
                <NavigationMenuLink variant="tournament" href="/admin/tournaments/manage">
                  <div className="text-sm font-medium text-white">Manage Active Events</div>
                </NavigationMenuLink>
                <NavigationMenuLink variant="tournament" href="/admin/tournaments/officials">
                  <div className="text-sm font-medium text-white">Official Assignments</div>
                </NavigationMenuLink>
              </div>
            </NavigationMenuContent>
          </TournamentNavigationItem>
...
export const TournamentNavigationPreset: Story = {
  render: () => (
    <TournamentNavigation>
      <NavigationMenuList variant="premium">
        <TournamentNavigationItem>
            ...
            <div className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              <div className="row-span-3">
                ...
                >
                  ...
                  <p className="text-sm leading-tight text-muted-foreground">
                    Elite-level competitive shooting with professional management.
                  </p>
                </NavigationMenuLink>
              </div>
              <NavigationMenuLink variant="premium" href="/tournaments/elite/live">
        ...
        <ScheduleNavigationItem>
          ...
          <NavigationMenuContent>
            <div className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2">
              <NavigationMenuLink variant="premium" href="/tournaments/registration">
                <Calendar className="h-4 w-4 mb-2 text-[#F2CB05]" />
                <div className="text-sm font-medium">Registration</div>
                <p className="text-xs text-muted-foreground">Event signup system</p>
              </NavigationMenuLink>
              <NavigationMenuLink variant="premium" href="/tournaments/schedule">
                <Users className="h-4 w-4 mb-2 text-[#F2CB05]" />
                <div className="text-sm font-medium">Squad Management</div>
                <p className="text-xs text-muted-foreground">Competitor assignments</p>
              </NavigationMenuLink>
            </div>
          </NavigationMenuContent>
        </ScheduleNavigationItem>
        <RangeNavigationItem>
          <NavigationMenuLink variant="premium" href="/tournaments/range">
            Range Control
          </NavigationMenuLink>
        </RangeNavigationItem>
      </NavigationMenuList>
