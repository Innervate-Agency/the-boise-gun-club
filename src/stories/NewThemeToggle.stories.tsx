  ...
  render: () => (
    <div className="space-y-8">
      <div className="text-center">
        <h3 className="text-lg font-heading font-bold text-craters-of-the-moon mb-4">
          Theme Toggle
        </h3>
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-6 bg-cloudy-day-white rounded-lg text-center">
          ...
          <h4 className="font-heading font-bold text-craters-of-the-moon mb-2">Light Mode</h4>
        ...
        <div className="p-6 bg-kent-slate-gray rounded-lg text-center">
          ...
          <h4 className="font-heading font-bold text-chester-white mb-2">Dark Mode</h4>
          <p className="text-sm text-don-gray">Low-light friendly</p>
        </div>
        <div className="p-6 bg-overcast rounded-lg text-center">
          <div className="text-2xl mb-2">🖥️</div>
          <h4 className="font-heading font-bold text-craters-of-the-moon mb-2">System</h4>
